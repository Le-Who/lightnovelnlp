      ...
      <div className="flex flex-col md:flex-row justify-between items-end border-b border-accent/20 pb-4 gap-4">
        ...
        <div className="flex gap-4 items-center">
          <div className="group flex items-center gap-2 border-b border-accent/30 p-1 bg-surface/50 hover:border-accent transition-colors">
            ...
            />
            <label className={`flex items-center px-4 py-1 bg-accent/10 hover:bg-accent text-accent hover:text-bg transition-all uppercase text-[10px] font-bold cursor-pointer tracking-wider focus-within:ring-2 focus-within:ring-accent ${uploadingChapters ? 'opacity-50 cursor-not-allowed' : ''}`}>
