...
def upgrade() -> None:
    ...
    op.add_column('projects', sa.Column('model_extraction', sa.String(100), nullable=True))
    op.add_column('projects', sa.Column('model_translation', sa.String(100), nullable=True))
    op.add_column('projects', sa.Column('model_summarization', sa.String(100), nullable=True))

    # Per-project thinking level overrides (NULL = inherit from ENV/config defaults)
    op.add_column('projects', sa.Column('thinking_extraction', sa.String(20), nullable=True))
    op.add_column('projects', sa.Column('thinking_translation', sa.String(20), nullable=True))
