...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_glossary_terms_first_chapter_id"),
        "glossary_terms",
        ["first_chapter_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_glossary_terms_last_chapter_id"),
        "glossary_terms",
        ["last_chapter_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_batch_job_items_project_id"),
        "batch_job_items",
        ["project_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_glossary_terms_last_chapter_id"), table_name="glossary_terms"
    )
    op.drop_index(
        op.f("ix_glossary_terms_first_chapter_id"), table_name="glossary_terms"
    )
